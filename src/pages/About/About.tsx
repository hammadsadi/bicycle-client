    ...
    <div className="bg-white">
      ...
      <section className="text-center py-12 px-4">
        ...
        <p className="mt-4 text-gray-700 max-w-2xl mx-auto">
          Our mission is to provide high-quality bicycles and accessories,
          making cycling accessible and enjoyable for everyone.
        </p>
      ...
      <section className="text-center py-12 px-4">
        <MyContainer>
          <h2 className="text-2xl font-bold">Our Bicycle Categories</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 max-w-5xl mx-auto">
          <div className="p-4 shadow-lg rounded-lg bg-white hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-700 mt-2">
              We offer the best quality bicycles and accessories at competitive
              prices.
            </p>
          </div>
          <div className="p-4 shadow-lg rounded-lg bg-white hover:shadow-xl transition-shadow">
          ...
          <div className="p-4 shadow-lg rounded-lg bg-white hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-700 mt-2">
              Get the best deals on top-quality bicycles and accessories.
            </p>
          </div>
        </div>
      </section>
